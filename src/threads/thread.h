...
struct thread
  {
    ...
    struct list child_list;             /* TODO: child process list*/
    struct list_elem child_elem;        /* TODO: elem as child in parent's child list */

    struct semaphore to_wait;           /* TODO: semaphore between this and its parent to start wait */
    struct semaphore to_th_exit;        /* TODO: semaphore between this and its parent to start thread_exit */

    /* TODO: exec status p-c problem between this and its parent */
    struct single_pc exec_status;

    /* TODO prj2: linked list of fds. 0 and 1 is always empty */
    struct list fd_list;                

    /* TODO prj2: file of executing process */
    struct file* file;
